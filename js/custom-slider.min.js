...
// Reusable function to initialize a Swiper slider
function initializeSwiper(containerSelector, scrollbarSelector) {
...
// Initialize each Swiper slider independently by targeting specific instances using data attribute
const sliders = document.querySelectorAll('.swiper-shopify-video');

sliders.forEach((slider) => {
    const swiperNumber = slider.getAttribute('data-swiper');
    const containerSelector = `.swiper-shopify-video[data-swiper="${swiperNumber}"]`;
    const scrollbarSelector = `.swiper-scrollbar[data-swiper="${swiperNumber}"]`;

    initializeSwiper(containerSelector, scrollbarSelector);
});


const videoUrl = new Swiper('.swiper-url-video', {
    // Optional parameters
    // direction: 'vertical',
    loop: false,
    slidesPerView: 2.2,
...
const essentialsSlider = new Swiper(".essentials_collection", {
    slidesPerView: 2,
    grabCursor: !0,
    spaceBetween: 10,
    loop: !1,
...
const exploreSlider = new Swiper(".kik_explore_right", {
    slidesPerView: 2,
    grabCursor: !0,
    spaceBetween: 10,
    loop: !0,
...
const testiSlider = new Swiper(".kik_testimonals_slides", {
    slidesPerView: "auto",
    grabCursor: !0,
    freeMode: !1,
    loop: !1,
